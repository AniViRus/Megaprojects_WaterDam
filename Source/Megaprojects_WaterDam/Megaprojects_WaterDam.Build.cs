...
public class Megaprojects_WaterDam : ModuleRules
{
	public Megaprojects_WaterDam(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange(new string[] {"FactoryGame", "SML", "MegaprojectsLib" });
